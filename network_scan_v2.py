...
OUTPUT_FILE = "network_results_with_port_service.xlsx"
...
ws.append(["IP", "Domain", "Port", "Service", "Process", "PID", "Country", "AS Name", "VT Score", "AbuseIPDB Score"])
...
# Write data rows
for (ip, port), info in found.items():
    dom = reverse_dns(ip)
